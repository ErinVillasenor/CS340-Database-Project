document.addEventListener("DOMContentLoaded", function(event)
{
	...
	function deleteRow(id)
	{
		...
		request.open("GET","/deleteLoc?id="+id,true)
	...
	function showTable()
	{
		...
		request.open('GET','/selectLoc',true)
		request.setRequestHeader('Content-Type', 'application/json');
		request.send(null);
		request.addEventListener('load',function()
		{
...
*/
		...
		request.addEventListener('load',function(){
            ...
            document.getElementById("error").textContent="Location name cannot be empty.";
        }
