document.addEventListener("DOMContentLoaded", function(event)
{
	...
	function deleteRow(id1,id2)
	{
        ...
        request.open("GET","/deleteCharAura?id1="+id1+"&id2="+id2,true)
	...
	function showTable(id)
	{
        ...
        var target="/selectCharAura?charId="+id;
		...
		request.addEventListener('load',function()
		{
    		...
    		for(var i=0;i<rows.length;i++)
    		{
    			...
    			newRow.textContent="This character has an aura of "+xx.aura_name;
...
function showDrop()
    ...
    function showDrop2()
        ...
        var request2= new XMLHttpRequest();
        request2.open('GET','/selectAur',true)
        request2.setRequestHeader('Content-Type', 'application/json');
        request2.send(null);
        request2.addEventListener('load',function()
        {
            ...
            for(var i=0;i<rows.length;i++)
            {
                ...
                newOption.textContent=xx.aura_name;
                newOption.value=xx.aura_id;
    ...
    document.getElementById("add").addEventListener("click", function(event){
        ...
        var id2=document.getElementById('Aura').value;
     
       

        var target='/insertCharAura?';

        target+='CharId='+id1+'&aura_id='+id2;
